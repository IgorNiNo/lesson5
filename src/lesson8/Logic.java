...
//        printMap();
        if (checkWinLines(DOT_X)) {
            ...
            JOptionPane.showMessageDialog( new GameWindow(), "Вы победили!");
            return;
        }
        if (isFull()) {
            //System.out.println("Ничья!");
            JOptionPane.showMessageDialog( new GameWindow(),"Ничья!");
            return;
        }
...
//        printMap();
        if (checkWinLines(DOT_O)) {
            ...
            JOptionPane.showMessageDialog( new GameWindow(),"Победил Искуственный Интеллект!");
            return;
        }
        if (isFull()) {
            //System.out.println("Ничья!");
