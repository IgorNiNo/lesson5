...
public class Settings extends JFrame {
    ...
    private static final int WINDOW_POS_X = GameWindow.WINDOW_POS_X + 30;
    private static final int WINDOW_POS_Y = GameWindow.WINDOW_POS_Y + 30;
    private static final int WINDOW_HEIGHT = GameWindow.WINDOW_HEIGHT - 60;
    private static final int WINDOW_WIDTH = GameWindow.WINDOW_WIDTH - 60;
    ...
    public Settings(GameWindow gameWindow) {
        ...
        JButton buttonStartGame = new JButton("OK");
        add(buttonStartGame);
